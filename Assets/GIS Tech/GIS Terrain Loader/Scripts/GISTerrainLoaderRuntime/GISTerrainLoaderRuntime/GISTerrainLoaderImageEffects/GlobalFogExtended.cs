...
namespace GISTech.GISTerrainLoader.ImageEffects
{
    [ExecuteInEditMode]
    ...
    class GlobalFogExtended : PostEffectsBase
    {
        ...
        private Vector3 camPos = Vector3.zero; //World Height Base
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            //fogMaterial.SetVector ("_HeightParams", new Vector4 (height, height, paramK, heightDensity*0.5f));
            ...
            //Advanced.sun = RenderSettings.sun.gameObject;
            ...
            if (Advanced.UseScattering)
                fogMaterial.SetFloat("_Scattering", 1);
            else
                fogMaterial.SetFloat("_Scattering", 0);
