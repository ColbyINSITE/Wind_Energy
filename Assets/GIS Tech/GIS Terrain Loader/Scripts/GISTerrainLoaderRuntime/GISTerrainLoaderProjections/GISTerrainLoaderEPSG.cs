...
{
    public class GISTerrainLoaderEPSG 
    {
        private static Dictionary<int, string> VerticalCSTypeGeoKeys = null;
        public static string GetEPSGName(int EPSGCode)
        {
            string name = "";

            if (VerticalCSTypeGeoKeys == null)
                LoadEPSGCodes();

            if (VerticalCSTypeGeoKeys.TryGetValue(EPSGCode, out name))
                return name;
        ...
        #region EPSGCodes
        private static void LoadEPSGCodes()
        {
            VerticalCSTypeGeoKeys = new Dictionary<int, string>
            {
