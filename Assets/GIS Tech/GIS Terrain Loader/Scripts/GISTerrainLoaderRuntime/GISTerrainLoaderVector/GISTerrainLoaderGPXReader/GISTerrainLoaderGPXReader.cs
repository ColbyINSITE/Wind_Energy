...
namespace GISTech.GISTerrainLoader
{
    ...
    public sealed class GISTerrainLoaderGPXFileLoader : IDisposable
    {
        ...
        public GISTerrainLoaderGPXFileLoader(Stream stream)
        {
    ...
    public class GpxLink
    {
        ...
        public Uri Uri
        { 
        get { return Uri.TryCreate(Href, UriKind.Absolute, out result) ? result : null; }
        }
    }
